...
public class SandboxArreglos
{
    ...
    public int[] getCopiaEnteros( )
    {
        ...
        // Se copian los valores del arreglo original al arreglo de copia
        // utilizando System.arraycopy() - Se utilizo ChatGPT
    ...
    {
    	String [] arreglo = new String[arregloCadenas.length+1];
    ...
    public void eliminarEntero( int valor )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++) {
            if (arregloEnteros[i] != valor) {
                arregloEnteros[count++] = arregloEnteros[i];
            }
        }
        int[] nuevoArreglo = new int[count];
        System.arraycopy(arregloEnteros, 0, nuevoArreglo, 0, count);
        arregloEnteros = nuevoArreglo;
    }
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        for (int i = 0; i < arregloCadenas.length; i++) {
            if (!arregloCadenas[i].equals(cadena)) {
                arregloCadenas[count++] = arregloCadenas[i];
            }
        }
        String[] nuevoArreglo = new String[count];
        System.arraycopy(arregloCadenas, 0, nuevoArreglo, 0, count);
        arregloCadenas = nuevoArreglo;
    }
    ...
    {	
        ...
        System.arraycopy(posiciones, 0, result, 0, count);
        return result;
    }
    ...
    public HashMap<Integer, Integer> calcularHistograma( )
    {
        ...
        for (int num : arregloEnteros) {
            // Se actualiza el valor del histograma para el número actual
            // Si el número ya está presente en el histograma, se incrementa su frecuencia
            // Si no está presente, se agrega al histograma con una frecuencia de 1 - Se utilizo ChatGPT
