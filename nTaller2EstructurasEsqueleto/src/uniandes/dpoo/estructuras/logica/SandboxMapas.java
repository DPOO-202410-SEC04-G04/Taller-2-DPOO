...
public class SandboxMapas
{
    ...
    {
    	List<String> sortedKeys = new ArrayList<>(mapaCadenas.keySet());
    ...
    public Collection<String> getLlaves( )
    {
    	...
    	for(int i=0; i<sortedKeys.size(); i++) {
    		llavesMayusculas.add(sortedKeys.get(i).toUpperCase());
    		}
    ...
    {
    	List<String> listaentera = new ArrayList<>(mapaCadenas.values());
    	List<String> listafinal = new ArrayList<>();
    	for(int i=0; i<listaentera.size(); i++) {
    		for(int j=0; j<listafinal.size(); j++) {
    			if(listaentera.get(i)!=listafinal.get(j)) {
    				listafinal.add(listaentera.get(i));
    			}
    		}
    	}
    	return listaentera.size();
    }
