...
public class SandboxConjuntos
{
    ...
    {
    	List<String> sortedList = new ArrayList<>(arbolCadenas);
    ...
    public List<String> getCadenasComoListaInvertida() {
     ...
     // Se ordena la lista en orden lexicográfico inverso, de mayor a menor. Se utilizo ChatGPT
        listaInvertida.sort((s1, s2) -> s2.compareTo(s1));
    ...
    public String getPrimera() {
        // Se verifica si el conjunto de cadenas está vacío usando el método isEmpty()
        // Si el conjunto está vacío, retorna null
        // De lo contrario, retorna la primera cadena del conjunto usando el método first() - Se utilizo ChatGPT
    ...
    public void eliminarPrimera() {
        if (!arbolCadenas.isEmpty()) {
            // Si el conjunto no está vacío, se elimina la primera cadena utilizando pollFirst() - Se utilizo ChatGPT
